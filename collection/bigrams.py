...
def process_bigrams(input_collection: 'list[list[str]]', min_count: 'int', threshold: 'int') -> 'list[list]':
  collection = input_collection.copy()

  # Transform document into bigrams and remove those who is less relevant
